...
export class PeriodicTableComponent {
  ...
  elements: Element[] = [
    ...
    { symbol: 'Cs', name: 'Caesium', atomicNumber: 55, group: 1, period: 6 },
  ...
  getElementAt(period: number, group: number): Element | null {
    return (
      this.elements.find((e) => e.period === period && e.group === group) ||
      null
    );
  }
}
